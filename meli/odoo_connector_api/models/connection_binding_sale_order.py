...
class OcapiConnectionBindingSaleOrderPayment(models.Model):
    ...
    _unique_conn_id_payment = versions.UniqueIndex('connection_account, conn_id, conn_variation_id, account_payment_id', message='Binding exists for this item: payment!')
...
class OcapiConnectionBindingSaleOrderShipmentItem(models.Model):
    ...
    _unique_conn_id_shipment_item = versions.UniqueIndex('connection_account, conn_id, shipping_id', message='Binding exists for this item: shipment.item!')
...
class OcapiConnectionBindingSaleOrderShipment(models.Model):
    ...
    _unique_conn_id_shipment = versions.UniqueIndex('connection_account, conn_id, order_id', message='Binding exists for this item: shipment!')
...
class OcapiConnectionBindingSaleOrderClient(models.Model):
    ...
    _unique_conn_id_res_partner = versions.UniqueIndex('connection_account, conn_id, conn_variation_id, partner_id', message='Binding exists for this item: client!')
...
class OcapiConnectionBindingSaleOrderLine(models.Model):
    ...
    _unique_conn_id_sale_order_line = versions.UniqueIndex('connection_account, conn_id, conn_variation_id, sale_order_line', message='Binding exists for this item: sale_order_line!')
...
class OcapiConnectionBindingSaleOrder(models.Model):
    ...
    _unique_conn_id_sale_order = versions.UniqueIndex('connection_account, conn_id, conn_variation_id, sale_order', message='Binding exists for this item: sale_order!')
