...
{
    'name': 'Odoo Connector Api - OCAPI',
    'version': '18.0.26.8',
    'author': 'Moldeo Interactive',
    'website': 'https://www.moldeointeractive.com',
    "category": "Sales",
    "summary": 'Base odoo connector api module for publishing system synchronisation',
    "description": 'OCAPI - Base connector module for MercadoLibre, Producteca and other marketplace integrations.',
    ...
    'data': [
        ...
        'views/account_unified_view.xml',
        'views/ocapi_menu.xml',
        'views/connector_registry_view.xml',
        'data/connector_registry_data.xml',
        #'data/cron_jobs.xml',
