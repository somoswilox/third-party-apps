{
    ...
    "live_test_url": "https://odoo-gantt18.bryntum.com",
    ...
    "data": [
        ...
        "views/res_users.xml",
        "views/gantt_event_color.xml",
        "data/gantt_event_color_data.xml",
    ],
    "application": True,
    ...
    "assets": {
        "web.assets_backend": [
            ...
            "/bryntum_gantt_enterprise/static/src/js/color_picker.js",
        ]
    },
